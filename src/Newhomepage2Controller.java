 ...
 */
public class Newhomepage2Controller implements Initializable {
        private Stage stage;
    private Scene scene;
    private Parent root;
    ...
    private void gotoprevious(ActionEvent event)throws IOException{
                        Parent root = FXMLLoader.load(getClass().getResource("newhomepage1.fxml"));
    ...
    private void gotoprofile(ActionEvent event) throws IOException{
                        Parent root = FXMLLoader.load(getClass().getResource("profilefxml"));
                        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
                        scene = new Scene(root);
                        stage.setScene(scene);
                        stage.setFullScreen(true);
